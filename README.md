...
[![Theme](https://img.shields.io/badge/Theme-Haunted%20Medical%20Lab-8b0000)]()
[![Built with Kiro AI](https://img.shields.io/badge/Built%20with-Kiro_AI-2a9d8f)]()
[![License](https://img.shields.io/badge/License-MIT-green)]()
[![Netlify Status](https://img.shields.io/badge/Deployed-Netlify-00C7B7)]()
...
<details>
<summary><strong>🦇 Halloween Special Modes</strong></summary>
...
```
Special Modes:
🔧 Frankenstein → Build from Parts
🧟 Mummy Wrappings → Layer Exploration  
🧛 Vampire → Circulatory System Deep Dive
🐺 Werewolf → Comparative Anatomy
```
</details>
...
<details>
<summary><strong>Full Stack Architecture</strong></summary>
...
║        FRONTEND           ║     BACKEND       ║
╠═══════════════════════════╬═══════════════════╣
║ React.js ⚛️ - PWA        ║ Kiro AI 🤖 - AI   ║
║ Three.js 🎮 - 3D Graphics║ Node.js 🟢 - Runtime║
║ Framer Motion 🎭 - Anim  ║ Medical APIs 🏥   ║
║ CSS3 🎨 - Styling        ║                   ║
╠═══════════════════════════╬═══════════════════╣
║        DEPLOYMENT         ║    PLATFORMS      ║
╠═══════════════════════════╬═══════════════════╣
║ Netlify ☁️ - Hosting     ║ Desktop 🖥️       ║
║ GitHub Actions ⚙️ - CI/CD║ Tablet 📱        ║
║ PWA 📱 - Offline         ║ Mobile 📱         ║
╚═══════════════════════════╩═══════════════════╝
```
</details>
...
┌─────────────┐    ┌─────────────┐    ┌─────────────┐
│             │    │             │    │             │
│ Requirements│───▶│   AI        │───▶│  Code       │
│   & Specs   │    │  Planning   │    │ Generation  │
│             │    │             │    │             │
└─────────────┘    └─────────────┘    └─────────────┘
                         │                    │
┌─────────────┐          │                    │
